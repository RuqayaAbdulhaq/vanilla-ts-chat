...
class ChatWidget {
    ...
    `;
        ...
        const userInput = chatWidget.querySelector("#chat-user-input");
    ...
    sendMessage(message, sentByUser) {
...
if (document.currentScript) {
    let position = "right";
    const scriptTag = document.querySelector('script[chat-data-position]');
    if (scriptTag) {
